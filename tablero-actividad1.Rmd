---
title: "Carrera La Luz 2022 - Manuel Anduquia"
...
**ANÁLISIS:** Categoría abierta tuvieron los mejores tiempos de carrera y juvenil menor participación.
...
ggplot(CarreraLuz22F, aes(x = categoria, y = timerun/60 )) +
  ...
  labs(title = "", y= "tiempo - min", x= "categorías")+
  scale_fill_brewer() +
  scale_fill_manual(values = c("#f9ddb1", "#f5c77e", "#f1b04c", "#ee9f27", "#ec9006","#e88504"))+
  theme(legend.position = "none")
t2m
```
